...
func Base(bs state.BaseState) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</a></div><div class=\"hidden md:block\"><div class=\"ml-10 flex items-baseline space-x-4\"><form autocomplete=\"off\"><input autocomplete=\"off\" name=\"hidden\" type=\"text\" class=\"hidden\"> <input autocomplete=\"off\" class=\"bg-zinc-900 text-sm font-medium text-zinc-300 rounded-full\" type=\"text\" name=\"search\" id=\"search\" placeholder=\"Search\" hx-trigger=\"keyup changed delay:500ms\" hx-post=\"/search\" hx-target=\"#main\" hx-swap=\"innerHTML\"></form><a href=\"/\" class=\"text-zinc-300 hover:bg-zinc-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
